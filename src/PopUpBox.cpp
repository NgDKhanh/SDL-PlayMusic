...
void PopUpBox::renderPopUpBox() {
    ...
    renderText(mMessage, popupX + 20, popupY + 20, textColor);
...
std::string PopUpBox::handlePopUpEvent(SDL_Event *event) {
